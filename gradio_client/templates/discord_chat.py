...
if not DISCORD_TOKEN:
    ...
    ### 2. Give your bot a name ЁЯдЦ

    ![](https://gradio-builds.s3.amazonaws.com/demo-files/discordbots/BotName.png)
    
    ## 3. In Settings > Bot, click the 'Reset Token' button to get a new token. Write it down and keep it safe ЁЯФР
...
"""
    ...
    тЪая╕П Note тЪая╕П: Please make sure this bot's command does have the same name as another command in your server.
    
    тЪая╕П Note тЪая╕П: Bot commands do not work in DMs with the bot as of now.
    """
